<?php
// Demo: mapa de prestadores con enfoque por prestador al hacer clic en una lista.
...
<head>
    ...
    <title>Mapa de prestadores (enfoque por prestador)</title>
...
<body>
    <div class="page">
        <header>
            <h1>Mapa de prestadores (enfoque)</h1>
            <p style="margin:0;font-size:0.85rem;opacity:0.8;">
                Elegí un prestador en la lista para centrar y hacer zoom en su zona.
            </p>
        </header>

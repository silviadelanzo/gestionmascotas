  ...
  <header class="sticky top-0 z-20">
    <div class="glass mx-auto max-w-6xl px-4 py-3 rounded-2xl mt-3 flex items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        <?php if ($isLogged): ?>
          ...
          <div class="user-menu">
            ...
            <div class="dropdown">
              ...
              <a data-href="<?= htmlspecialchars($baseUrl, ENT_QUOTES, 'UTF-8') ?>/api/logout.php" class="dropdown-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <?php else: ?>
          <a class="pill btn-primary" data-href="<?= htmlspecialchars($loginUrl, ENT_QUOTES, 'UTF-8') ?>">Ingresar a mi cuenta</a>
        <?php endif; ?>
      </div>
    </div>
  </header>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="glass rounded-3xl p-6 md:p-8 shadow-2xl text-center">
          ...
          <div class="flex flex-wrap gap-3 justify-center">
            <?php if (!$isLogged): ?>
              <a class="pill btn-brown" data-href="<?= htmlspecialchars($registroDueno, ENT_QUOTES, 'UTF-8') ?>">Crear cuenta dueño/a</a>
              <a class="pill btn-brown" data-href="<?= htmlspecialchars($registroPrestador, ENT_QUOTES, 'UTF-8') ?>">Crear cuenta prestador/a</a>
            <?php else: ?>
              <a class="pill btn-brown" data-href="<?= htmlspecialchars($launchUrl, ENT_QUOTES, 'UTF-8') ?>">Ir al launchpad</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
